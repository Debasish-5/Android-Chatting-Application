...
import com.example.chattingapplication.ChatActivity;
...
public class SearchUserRecyclerAdapter extends FirestoreRecyclerAdapter<UserModel, SearchUserRecyclerAdapter.UserModelViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull UserModelViewHolder holder, int position, @NonNull UserModel model) {
        ...
        // Assume you have a method in FirebaseUtil to get the current user's phone number
        String currentUserPhoneNumber = FirebaseUtil.getCurrentUserPhoneNumber();

        if (model.getPhone().equals(currentUserPhoneNumber)) {
